    ...
    <div className="space-y-6">
        ...
        {isAdmin && (
          <div className="relative w-80">
            ...
            {searchQuery && !isSearching && searchResults.length === 0 && (
              <div className="absolute z-10 w-full mt-1 bg-popover shadow-lg rounded-md border">
      ...
      {showAddForm && (
        <div className="bg-card border rounded-lg p-4">
          ...
          <form ref={formRef} action={handleCreatePlayer} className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                <label htmlFor="pdga_number" className="text-sm font-medium mb-1 block">
                  PDGA Number
                </label>
                <Input
                  id="pdga_number"
              ...
              <div>
                <label htmlFor="phone_number" className="text-sm font-medium mb-1 block">
                  Phone Number
                </label>
                <Input
                  id="phone_number"
